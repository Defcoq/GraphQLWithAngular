using GraphQL.AspnetCore.Client.ResponseTypes;
...
namespace GraphQL.AspnetCore.Client
{
    public class OwnerConsumer
    {
        ...
        public async Task<Owner> CreateOwner(Owner ownerToCreate)
        {
            var query = new GraphQLRequest
            {
                Query = @"
        ...
        public async Task<Owner> UpdateOwner(Guid id, Owner ownerToUpdate)
        {
            var query = new GraphQLRequest
            {
                Query = @"
        ...
        public async Task<string> DeleteOwner(Guid id)
        {
            ...
            var response = await _client.SendMutationAsync<ResponseOwnerType>(query);
            return response.Data.Owner.Name;
        }
    }
}
